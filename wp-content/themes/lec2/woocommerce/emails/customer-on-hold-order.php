                                            ...
                                            <tr>
                                                <td valign="top" style="padding:28px 48px 12px">
                                                    <div style="color:#636363;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                                        ...
                                                        function code_to_country_customer_on_hold_order( $code ){
                                                        ...
                                                        function renderEmailLineCustomerOnHoldOrder($label,$para){
                                                            if($para!=null && $para!='') {
                                                        ...
                                                        $billing_country = code_to_country_customer_on_hold_order($order->get_billing_country()) ?? '';
                                                        ...
                                                        renderEmailLineCustomerOnHoldOrder($salutationLabel,$billing_salutation);
                                                        renderEmailLineCustomerOnHoldOrder($titleLabel,$billing_title);
                                                        renderEmailLineCustomerOnHoldOrder($firstNameLabel,$billing_first_name);
                                                        renderEmailLineCustomerOnHoldOrder($lastNameLabel,$billing_last_name);
                                                        renderEmailLineCustomerOnHoldOrder($companyLabel,$billing_company);
                                                        renderEmailLineCustomerOnHoldOrder($divisionLabel,$billing_division);
                                                        renderEmailLineCustomerOnHoldOrder($addressLabel,$billing_address_1);
                                                        renderEmailLineCustomerOnHoldOrder($postalCodeLabel,$billing_postcode);
                                                        renderEmailLineCustomerOnHoldOrder($cityLabel,$billing_city);
                                                        renderEmailLineCustomerOnHoldOrder($countryLabel,$billing_country);
                                                        renderEmailLineCustomerOnHoldOrder($phoneLabel,$billing_phone);
                                                        renderEmailLineCustomerOnHoldOrder($faxLabel,$billing_fax);
                                                        renderEmailLineCustomerOnHoldOrder($emailLabel,$billing_email);
                                                        renderEmailLineCustomerOnHoldOrder($couponCodeLabel,$billing_coupon_code);
                                                        renderEmailLineCustomerOnHoldOrder($VATNumberLabel,$billing_vat_number);
                                                        renderEmailLineCustomerOnHoldOrder($orderNumberLabel,$billing_order_number);
                                                        renderEmailLineCustomerOnHoldOrder($messageLabel,$billing_message);
                                                        ...
                                                        if ( $order->has_shipping_address() && get_post_meta($order_id,'order_custom_ship_to_different_address',true)==1) {
                                                            ...
                                                            $shipping_country = code_to_country_customer_on_hold_order($order->get_shipping_country()) ?? '';
                                                            ...
                                                            renderEmailLineCustomerOnHoldOrder($salutationLabel,$shipping_salutation);
                                                            renderEmailLineCustomerOnHoldOrder($titleLabel,$shipping_title);
                                                            renderEmailLineCustomerOnHoldOrder($firstNameLabel,$shipping_first_name);
                                                            renderEmailLineCustomerOnHoldOrder($lastNameLabel,$shipping_last_name);
                                                            renderEmailLineCustomerOnHoldOrder($companyLabel,$shipping_company);
                                                            renderEmailLineCustomerOnHoldOrder($divisionLabel,$shipping_division);
                                                            renderEmailLineCustomerOnHoldOrder($addressLabel,$shipping_address_1);
                                                            renderEmailLineCustomerOnHoldOrder($postalCodeLabel,$shipping_postcode);
                                                            renderEmailLineCustomerOnHoldOrder($cityLabel,$shipping_city);
                                                            renderEmailLineCustomerOnHoldOrder($countryLabel,$shipping_country);
                                                            renderEmailLineCustomerOnHoldOrder($phoneLabel,$shipping_phone);
                                                            renderEmailLineCustomerOnHoldOrder($faxLabel,$shipping_fax);
                                                            renderEmailLineCustomerOnHoldOrder($emailLabel,$shipping_email);
                                                            renderEmailLineCustomerOnHoldOrder($couponCodeLabel,$shipping_coupon_code);
                                                            renderEmailLineCustomerOnHoldOrder($VATNumberLabel,$shipping_vat_number);
                                                            renderEmailLineCustomerOnHoldOrder($orderNumberLabel,$shipping_order_number);
                                                            renderEmailLineCustomerOnHoldOrder($messageLabel,$shipping_message);
                                                        }
